...
/***/ function(module, exports, __webpack_require__) {
	...
	var TileController = __webpack_require__(1)
	var TileModel = __webpack_require__(6)        

	$(document).ready(function() {
	            
	    var model = new TileModel();
	                    
	    var controller = new TileController(model, "http://localhost:60217");
	    controller.init();
	            
	    var connection = $.hubConnection("http://localhost:60217");
